export default {
  ...
  redis: {
    ...
    connectionNamePlaceholder: 'My Redis Server',
    host: 'Host',
    ...
    searchKeysPlaceholder: 'e.g., user:123',
    ...
    pattern: 'Pattern',
    patternPlaceholder: '* (e.g., user:*, cache:*)',
    preview: 'Preview',
    execute: 'Execute',
  ...
  api: {
    ...
    unnamed: 'Unnamed',
    baseUrlDescription: 'API Base URL',
    ...
    apiKeyPlaceholderHeader: 'X-API-Key',
    addTo: 'Add to',
  ...
  database: {
    ...
    connectionFailed: 'Connection failed',
    charsetRecommended: 'Recommended',
    hostPlaceholderDb: 'localhost',
  ...
  ai: {
    // Configuration
    configTitle: 'AI Model Configuration',
    configHint: 'Configure LLM API to enable AI assistance. Supports OpenAI, Anthropic, DeepSeek, Zhipu, Baidu, Alibaba, and other major providers.',
    noConfig: 'No AI configuration',
    addConfig: 'Add Configuration',
    activeConfig: 'Active Config',
    noActiveConfig: 'No active configuration',
    configName: 'Config Name',
    configNamePlaceholder: 'e.g.: Work, Personal',
    provider: 'Provider',
    apiKey: 'API Key',
    ...
    testConnection: 'Test',
    testing: 'Testing...',
    noValidConfig: 'Please configure a valid AI model first',
    noValidConfigWarning: 'No valid AI model configured, click configure button to add',

    // Feature Panel
    sqlGenerate: 'AI Generate SQL',
    sqlGeneratePlaceholder: 'Describe your query needs, e.g.: Find users registered in the last 7 days',
    sqlGenerateDesc: 'Describe your query in natural language, AI will generate the corresponding SQL statement.',
    sqlExplain: 'AI Explain SQL',
    sqlExplainPlaceholder: 'Enter the SQL statement to explain',
    sqlExplainDesc: 'Enter a complex SQL statement, AI will explain its meaning and functionality.',
    dataGenerate: 'AI Generate Test Data',
    dataGeneratePlaceholder: 'Describe test data needed, e.g.: Generate 10 user records',
    dataGenerateDesc: 'Generate reasonable test data INSERT statements based on table structure.',
    ...
    processing: 'Processing...',
    apply: 'Apply',
    waitingInput: 'Waiting for execution...',
    ...
    mediumRiskTitle: 'Risk Operation Confirmation',
    confirmExecute: 'Confirm Execute',
    highRiskBlocked: 'High risk operation blocked, execution prohibited',
    confirmAndExecute: 'Confirm & Execute',
    noTableSelected: 'No table selected. Please select a table from the sidebar, or specify table name in your description',

    // Intent Matching
    selectTable: 'Select Table',
    searchTable: 'Search table name or comment',
    specifiedTable: 'Query table specified',
    aiMatchedTable: 'AI matched table',
    tableMismatch: 'Table mismatch',
    youSpecified: 'You specified',

    // SQL Analyzer
    sqlAnalyzer: 'SQL Analyzer',
    sqlAnalyzerDesc: 'Comprehensive SQL analysis for performance, security and optimization',
    sqlInput: 'SQL Input',
    sqlInputPlaceholder: 'Paste SQL statement for analysis...',
    pasteFromClipboard: 'Paste from clipboard',
    analyze: 'Analyze',
    analyzing: 'Analyzing...',
    waitingSQL: 'Waiting for SQL input...',
    clear: 'Clear',
    ...
    noOptimizationNeeded: 'SQL is well optimized, no improvements needed',
    indexSuggestions: 'Index Suggestions',
    rewrittenSQL: 'SQL Rewrite',
    ...
    // Database specific
    aiConfig: 'AI Config',
    aiSqlGenerate: 'AI Generate SQL',
    aiSqlExplain: 'AI Explain SQL',
    aiDataGenerate: 'AI Generate Test Data',
  },
